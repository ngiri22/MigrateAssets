...
--Asset master table
CREATE TABLE LUMILEDS_MIGRATION_PAL_ASSET_MASTER (
	ID VARCHAR(100),
	VERSION VARCHAR(5),
	ISMASTER VARCHAR(5),
...
CREATE TABLE LUMILEDS_MIGRATION_PAL_ASSET_METADATA (
	ID varchar(100),
	NAME varchar(50),
	FIELD varchar(1000)
);

--Asset taxonomy table
CREATE TABLE LUMILEDS_MIGRATION_PAL_ASSET_TAXONOMY (
	ID VARCHAR(100),
